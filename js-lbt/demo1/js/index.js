...
function SetuserPannel(){
    var cookie = GeetCoolie('userPannel');
    if(cookie != 'close'){
...
function SetuserUserInfoPannel(){
    var cookie = GeetCoolie('userInfo');
    if(cookie != 'close'){
        CF.commom.userPannel.showPrompt('#userPannel-userInfo');
    }
}
